...
import 'package:flutter_proj/PasswordStrength.dart';
...
class CustomCanvas extends CustomPainter {
  ...
  CustomCanvas({this.colors, this.strength, this.colorTo, this.colorFrom, this.colorStops, this.padding, this.drawType, this.label, this.textStyle});
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for(var i = 0; i < _colors.length; i++) {
      ...
      if(drawType == DrawType.LINE) {
        canvas.drawLine(Offset(startX + _padding / 2, verticalOffset ), Offset(startX + width - _padding, verticalOffset ), paint);
